...
<td style="width: 301px; height: 116.188px;">Seleziona files da caricare
  <form enctype="multipart/form-data" action="upload_amz.php" method="post">
        <div>
<?php
echo
    <<<EOT
...
<form enctype="multipart/form-data" action="elab_amazon.php" method="post">

<br><br>Contabiltà ditta<br>
<label for="id_label_single2">

<select id='tper'   style="width: 300px"  name="tper">
<option></option>
<option value=1>Semplificata</option>
<option selected="selected"  value=3>S1</option>
