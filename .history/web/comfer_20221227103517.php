...
<td style="width: 301px; height: 116.188px;">Seleziona files da caricare
  <form enctype="multipart/form-data" action="upload_comf.php" method="post">
        <div>
<?php
echo
    <<<EOT
...
<form enctype="multipart/form-data" action="elab_comfer.php" method="post">
