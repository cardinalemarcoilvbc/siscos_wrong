...
var_dump(ltrim(rtrim($tmp_arr['9'])));
var_dump(ltrim(rtrim($tmp_arr['10'])));
var_dump(ltrim(rtrim($tmp_arr['11'])));
var_dump('cano');
$val_9=number_format((float)(str_replace(',','.',ltrim(rtrim($tmp_arr['9'])))), 3 );
$val_10=number_format((float) (str_replace(',','.',ltrim(rtrim($tmp_arr['10'])))), 3);

$val_11=number_format((float) (str_replace(',','.',ltrim(rtrim($tmp_arr['11'])))), 3);

$var11_niva=$val_10-$val_11;
var_dump($val_9);
var_dump($val_10);
var_dump($val_11);
var_dump($var11_niva);
