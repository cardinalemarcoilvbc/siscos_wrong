...
$allFT = str_replace('{var1}', $tmp_arr['0'], $ini_array['percorsi']['str_corri_1']);
...
$allFT = '';
$allFT = str_replace('{var1}', $tmp_arr['0'], $ini_array['percorsi']['str_corri_2']);
$allFT = str_replace('{var2}', $tmp_arr['1'], $allFT);
$allFT = str_replace('{var3}', $tmp_arr['2'], $allFT);
$allFT = str_replace('{var4}', $tmp_arr['3'], $allFT);
$allFT = str_replace('{var5}', $tmp_arr['4'], $allFT);
...
$corrispettivi = $corrispettivi . $allFT . PHP_EOL;
$allFT = '';
$allFT = str_replace('{var1}', $tmp_arr['0'], $ini_array['percorsi']['str_corri_3']);
$allFT = str_replace('{var2}', $tmp_arr['1'], $allFT);
$allFT = str_replace('{var3}', $tmp_arr['2'], $allFT);
$allFT = str_replace('{var4}', $tmp_arr['3'], $allFT);
$allFT = str_replace('{var5}', $tmp_arr['4'], $allFT);
...
$corrispettivi = $corrispettivi . $allFT . PHP_EOL;
$allFT = '';
$allFT = str_replace('{var1}', $tmp_arr['0'], $ini_array['percorsi']['str_corri_4']);
$allFT = str_replace('{var2}', $tmp_arr['1'], $allFT);
$allFT = str_replace('{var3}', $tmp_arr['2'], $allFT);
$allFT = str_replace('{var4}', $tmp_arr['3'], $allFT);
$allFT = str_replace('{var5}', $tmp_arr['4'], $allFT);
