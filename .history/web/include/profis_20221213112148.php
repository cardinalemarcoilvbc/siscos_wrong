...
//var_dump($c1);
//var_dump($c2);
                   $tmp_arr['9']= ltrim(rtrim(str_replace(',', '.', (str_replace('.', '', $tmp_arr['9'])))));
 $tmp_arr['10'] = ltrim(rtrim(str_replace(',', '.', (str_replace('.', '', $tmp_arr['10'])))));
$tmp_arr['11'] = ltrim(rtrim(str_replace(',', '.', (str_replace('.', '', $tmp_arr['11'])))));
