...
var_dump('cano');
$val_9=number_format((float)(ltrim(rtrim($tmp_arr['9']))), 2 );
$val_10=number_format((float) (ltrim(rtrim($tmp_arr['10']))), 2);

$val_11=number_format((float) (ltrim(rtrim($tmp_arr['11']))), 2);
