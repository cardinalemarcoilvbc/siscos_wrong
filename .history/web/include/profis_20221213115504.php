...
var_dump('cano');
$val_9=number_format((float)(str_replace(',','.',ltrim(rtrim($tmp_arr['9'])))), 2 );
$val_10=number_format((float) (str_replace(',','.',ltrim(rtrim($tmp_arr['10'])))), 2);

$val_11=number_format((float) (str_replace(',','.',ltrim(rtrim($tmp_arr['11'])))), 2);

$var11_niva=str_pad(str_replace('.', ',',$val_10-$val_11),17, ' ', STR_PAD_LEFT);
var_dump($val_9);
var_dump($val_10);
var_dump($val_11);
var_dump($var11_niva);
