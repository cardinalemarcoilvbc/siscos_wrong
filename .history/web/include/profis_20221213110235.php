...
var_dump($tmp_arr['10']);
var_dump($tmp_arr['11']);
var_dump($ls->withoutRounding((str_replace('.', '',$tmp_arr['9'])),3));
var_dump($ls->withoutRounding($tmp_arr['10'], 3));
var_dump($ls->withoutRounding($tmp_arr['11'], 3));


var_dump(floatval(preg_replace("/[^-0-9\.]/","",$tmp_arr['9'])));
