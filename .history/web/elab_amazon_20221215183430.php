...
foreach ($elef as $t) {
    ...
    $riga = $pfs->crea_amz_File(basename($t),
...
border="1" width="311" cellspacing="10" cellpadding="10">
<tbody><TD><BR><H1>
<a href="{$z}">Scarica File (ZIP)</a></h1><br/>
</td></tbody></table>
