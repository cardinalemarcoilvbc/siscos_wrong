...
//file2 = file_get_contents($file_);
    ...
    public function zipper_amz()
    {
        ...
        // foreach ($files as $file) {
        $zip->addFile($uno);
        /*messsi sti due delete perchè non ho capito dove prende i nomi...mannaggia a il cazzo....*/
        $zip->deleteName('ft_amz.csv');
        $zip->deleteName('corri_amz.csv');
...
//die();
    ...
    public function crea_amz_File($file, $tper = null, $id = null, $ateco = null)
    {
        $ini_array = parse_ini_file("config.ini", true/* will scope sectionally */);
...
//EOT.PHP_EOL;
                    ...
                    //ft
                    $tmp_arr['4'] = ltrim(rtrim($tmp_arr['4']));
                    $tmp_arr['5'] = ltrim(rtrim($tmp_arr['5']));
                    $tmp_arr['6'] = ltrim(rtrim($tmp_arr['6']));

                    $tmp_arr['3'] = str_replace('.', '', $tmp_arr['3']);
                    $tmp_arr['8'] = str_pad(ltrim(rtrim(str_replace('.', '', $tmp_arr['8']))), 15, ' ', STR_PAD_LEFT);
                    ...
                    //ft
                    $tmp_arr['4'] = str_pad(ltrim(rtrim(str_replace('.', '', $tmp_arr['4']))), 15, ' ', STR_PAD_LEFT);
                    $tmp_arr['5'] = str_pad(ltrim(rtrim(str_replace('.', '', $tmp_arr['5']))), 15, ' ', STR_PAD_LEFT);
                    $tmp_arr['6'] = str_pad(ltrim(rtrim(str_replace('.', '', $tmp_arr['6']))), 15, ' ', STR_PAD_LEFT);
                    ...
                    $v9 = str_replace('.', '|', $val_9);
                    $v9 = str_replace(',', '', $val_9);
                    $v10 = str_replace('.', '|', $val_10);
                    $v10 = str_replace(',', '', $val_10);
                    $Svar10 = $v10 + $v9;
                    ...
                    $allv = str_replace('{Svar10}', str_pad($v10 + $v9, 16, ' ', STR_PAD_LEFT), $allv);
                    $allv = str_replace('{Svar10_l9}', substr(str_pad($v10 + $v9, 15, ' ', STR_PAD_LEFT), -9), $allv);

                    $allv = str_replace('{C1}', $c1, $allv);
                    $allv = str_replace('{C2}', $c2, $allv);
                    $allv = str_replace('{C3}', $c3, $allv);
                    $allv = str_replace('{C4}', $c4, $allv);
...
////////////////////fattuireeeeeee//////////////////
                    ...
                    if (ltrim(rtrim($tmp_arr['4'])) != '-' && ltrim(rtrim($tmp_arr['4'])) != '') {
                        $allFT = '';
                        $allFT = str_replace('{var1}', $tmp_arr['0'], $ini_array['percorsi']['str_ft_1']);
                        $allFT = str_replace('{var2}', $tmp_arr['1'], $allFT);
                        $allFT = str_replace('{var3}', $tmp_arr['2'], $allFT);
                        $allFT = str_replace('{var4}', $tmp_arr['3'], $allFT);
                        $allFT = str_replace('{var5}', $tmp_arr['4'], $allFT);
                        $allFT = str_replace('{var5_l9}', substr($tmp_arr['4'], -9), $allFT);
                        $allFT = str_replace('{R_var5_l9}', str_pad((ltrim(rtrim($tmp_arr['4']))), 9, ' ', STR_PAD_RIGHT), $allFT);

                        $allFT = str_replace('{var6}', $tmp_arr['5'], $allFT);
                        $allFT = str_replace('{var7}', $tmp_arr['6'], $allFT);
                        $allFT = str_replace('{var8}', $tmp_arr['7'], $allFT);
                        $allFT = str_replace('{var9}', $tmp_arr['8'], $allFT);
                        $allFT = str_replace('{var10}', $tmp_arr['9'], $allFT);
                        $allFT = str_replace('{var11}', $tmp_arr['10'], $allFT);
                        $allFT = str_replace('{var10_l9}', substr($tmp_arr['9'], -9), $allFT);
                        $allFT = str_replace('{var11_l9}', substr($tmp_arr['10'], -9), $allFT);
                        $allFT = str_replace('{ndoc}', str_pad($ndoc, 20, ' ', STR_PAD_LEFT), $allFT);
                        $allFT = str_replace('{ndoc7}', str_pad($ndoc, 7, ' ', STR_PAD_LEFT), $allFT);

                        $allFT = str_replace('{suf}', str_pad('FT', 12, ' ', STR_PAD_LEFT), $allFT);
                        $allFT = str_replace('{var12}', $tmp_arr['11'], $allFT);
                        $allFT = str_replace('{var11_niva}', $var11_niva, $allFT);
                        $allFT = str_replace('{Svar10}', str_pad($v10 + $v9, 16, ' ', STR_PAD_LEFT), $allFT);
                        $allFT = str_replace('{Svar10_l9}', substr(str_pad($v10 + $v9, 15, ' ', STR_PAD_LEFT), -9), $allFT);

//var_dump(str_pad($v10+$v9,16,' ',STR_PAD_LEFT));

//$allFT = str_replace('{var10_niva}', $var10_niva, $allFT);

                        $allFT = str_replace('{C1}', $c1, $allFT);
                        $allFT = str_replace('{C2}', $c2, $allFT);
                        $allFT = str_replace('{C3}', $c3, $allFT);
                        $allFT = str_replace('{C4}', $c4, $allFT);

                        $allFT = str_replace('{22}', $i22, $allFT);
                        $allFT = str_replace('{16}', $i16, $allFT);
                        $allFT = str_replace('{C4_0}', $c4_0, $allFT);
                        $allFT = str_replace('{desft}', $ini_array['percorsi']['desft'], $allFT);
                        $allFT = str_replace('{F1}', $ini_array['percorsi']['F1'], $allFT);
                        $allFT = str_replace('{F2}', $ini_array['percorsi']['F2'], $allFT);
                        $allFT = str_replace('{F3}', $ini_array['percorsi']['F3'], $allFT);
                        $allFT = str_replace('{F4}', $ini_array['percorsi']['F4'], $allFT);
                        $allFT = str_replace('{F4_0}', $ini_array['percorsi']['F4_0'], $allFT);

                        $allFT = str_replace('{escont}', $anno_contabile, $allFT);
                        $fatture = $fatture . $allFT . PHP_EOL;

                        $allFT = '';
                        $allFT = str_replace('{var1}', $tmp_arr['0'], $ini_array['percorsi']['str_ft_2']);
                        $allFT = str_replace('{var2}', $tmp_arr['1'], $allFT);
                        $allFT = str_replace('{var3}', $tmp_arr['2'], $allFT);
                        $allFT = str_replace('{var4}', $tmp_arr['3'], $allFT);
                        $allFT = str_replace('{var5}', $tmp_arr['4'], $allFT);
...
//$allFT = str_replace('{var10_niva}', $var10_niva, $allFT);
                        ...
                        $allFT = str_replace('{22}', $i22, $allFT);
                        $allFT = str_replace('{16}', $i16, $allFT);
                        $allFT = str_replace('{C4_0}', $i16, $allFT);
                        $allFT = str_replace('{desft}', $ini_array['percorsi']['desft'], $allFT);
                        $allFT = str_replace('{F1}', $ini_array['percorsi']['F1'], $allFT);
                        $allFT = str_replace('{F2}', $ini_array['percorsi']['F2'], $allFT);
                        $allFT = str_replace('{F3}', $ini_array['percorsi']['F3'], $allFT);
                        ...
                        $allFT = '';
                        $allFT = str_replace('{var1}', $tmp_arr['0'], $ini_array['percorsi']['str_ft_3']);
                        $allFT = str_replace('{var2}', $tmp_arr['1'], $allFT);
                        $allFT = str_replace('{var3}', $tmp_arr['2'], $allFT);
                        $allFT = str_replace('{var4}', $tmp_arr['3'], $allFT);
                        $allFT = str_replace('{var5}', $tmp_arr['4'], $allFT);
...
//$allFT = str_replace('{var10_niva}', $var10_niva, $allFT);
                        ...
                        $allFT = '';
                        $allFT = str_replace('{var1}', $tmp_arr['0'], $ini_array['percorsi']['str_ft_4']);
                        $allFT = str_replace('{var2}', $tmp_arr['1'], $allFT);
                        $allFT = str_replace('{var3}', $tmp_arr['2'], $allFT);
                        $allFT = str_replace('{var4}', $tmp_arr['3'], $allFT);
                        $allFT = str_replace('{var5}', $tmp_arr['4'], $allFT);
...
//$allFT = str_replace('{var10_niva}', $var10_niva, $allFT);
                        ...
                        $allFT = str_replace('{escont}', $anno_contabile, $allFT);
                        $allFT = str_replace(',', '.', $allFT);

                        $fatture = $fatture . $allFT . PHP_EOL;
                        $fatture = str_replace(',', '.', $fatture);
                    }
/////////////////////////////////////////////////////////ft con iva 22
/////////////////////////////////////////////////////////ft con iva 22
/////////////////////////////////////////////////////////ft con iva 22
...
/////////////////////////////////////////////////////////ft con iva 22
/////////////////////////////////////////////////////////ft con iva 22
//var_dump(ltrim(rtrim($tmp_arr['6'])));
                    if ((ltrim(rtrim($tmp_arr['5'])) != '-' && ltrim(rtrim($tmp_arr['5'])) != '')
                    ||
                    (ltrim(rtrim($tmp_arr['6'])) != '-' && ltrim(rtrim($tmp_arr['6'])) != '')
                    ) {
                        $allFT = '';

                        $val_5 = number_format((float)
                            (str_replace(',', '.', ltrim(rtrim(
                                str_replace('.', '', $tmp_arr['5'])
                            ))))
                            , 2);
                        $val_6 = number_format((float)
                            (str_replace(',', '.', ltrim(rtrim(
                                str_replace('.', '', $tmp_arr['6'])

                            ))))

                            , 2);
                        $v5 = str_replace('.', '|', $val_5);
                        $v5 = str_replace(',', '', $val_5);
                        $v6 = str_replace('.', '|', $val_6);
                        $v6 = str_replace(',', '', $val_6);
                        ...
                        $allFT = str_replace('{var1}', $tmp_arr['0'], $ini_array['percorsi']['str_ft_1_22']);
                        $allFT = str_replace('{var2}', $tmp_arr['1'], $allFT);
                        $allFT = str_replace('{var3}', $tmp_arr['2'], $allFT);
                        $allFT = str_replace('{var4}', $tmp_arr['3'], $allFT);
                        $allFT = str_replace('{var5}', $tmp_arr['4'], $allFT);
                        ...
                        $allFT = str_replace('{var6}', $tmp_arr['5'], $allFT);
                        $allFT = str_replace('{var6_l9}', substr($tmp_arr['5'], -9), $allFT);
                        $allFT = str_replace('{R_var6_l9}', str_pad((ltrim(rtrim($tmp_arr['5']))), 9, ' ', STR_PAD_RIGHT), $allFT);
                        $allFT = str_replace('{var7}', $tmp_arr['6'], $allFT);
                        $allFT = str_replace('{var7_l9}', substr($tmp_arr['6'], -9), $allFT);
                        $allFT = str_replace('{R_var7_l9}', str_pad((ltrim(rtrim($tmp_arr['6']))), 9, ' ', STR_PAD_RIGHT), $allFT);
                        $allFT = str_replace('{R_Svar76_l9}', str_pad((ltrim(rtrim($R_Svar76_l9))), 9, ' ', STR_PAD_RIGHT), $allFT);
...
//$allFT = str_replace('{var10_niva}', $var10_niva, $allFT);
                        ...
                        $allFT = '';
                        $allFT = str_replace('{var1}', $tmp_arr['0'], $ini_array['percorsi']['str_ft_2_22']);
                        $allFT = str_replace('{var2}', $tmp_arr['1'], $allFT);
                        $allFT = str_replace('{var3}', $tmp_arr['2'], $allFT);
                        $allFT = str_replace('{var4}', $tmp_arr['3'], $allFT);
                        $allFT = str_replace('{var5}', $tmp_arr['4'], $allFT);
...
//$allFT = str_replace('{var10_niva}', $var10_niva, $allFT);
                        ...
                        $allFT = '';
                        $allFT = str_replace('{var1}', $tmp_arr['0'], $ini_array['percorsi']['str_ft_3_22']);
                        $allFT = str_replace('{var2}', $tmp_arr['1'], $allFT);
                        $allFT = str_replace('{var3}', $tmp_arr['2'], $allFT);
                        $allFT = str_replace('{var4}', $tmp_arr['3'], $allFT);
                        $allFT = str_replace('{var5}', $tmp_arr['4'], $allFT);
...
//$allFT = str_replace('{var10_niva}', $var10_niva, $allFT);
                        ...
                        $allFT = '';
                        $allFT = str_replace('{var1}', $tmp_arr['0'], $ini_array['percorsi']['str_ft_4_22']);
                        $allFT = str_replace('{var2}', $tmp_arr['1'], $allFT);
                        $allFT = str_replace('{var3}', $tmp_arr['2'], $allFT);
                        $allFT = str_replace('{var4}', $tmp_arr['3'], $allFT);
                        $allFT = str_replace('{var5}', $tmp_arr['4'], $allFT);
...
///////////////////////////////fatturaniva
///////////////////////////////fatturaniva
///////////////////////////////fatturaniva///////////////////////////////fatturaniva
///////////////////////////////fatturaniva

                    if (ltrim(rtrim($tmp_arr['8'])) != '-' && ltrim(rtrim($tmp_arr['8'])) != '') {

                        $allFT = '';
                        $ndoc = $ndoc + 1;

                        $allFT = str_replace('{var1}', $tmp_arr['0'], $ini_array['percorsi']['str_ft_1_niva']);
                        $allFT = str_replace('{var2}', $tmp_arr['1'], $allFT);
                        $allFT = str_replace('{var3}', $tmp_arr['2'], $allFT);
                        $allFT = str_replace('{var4}', $tmp_arr['3'], $allFT);
                        $allFT = str_replace('{var5}', $tmp_arr['4'], $allFT);
                        ...
                        $allFT = str_replace('{defpiva}', $ini_array['percorsi']['defpiva'], $allFT);
                        $allFT = str_replace('{niva}', $ini_array['percorsi']['niva'], $allFT);
                        $allFT = str_replace('{desft_niva}', $ini_array['percorsi']['desft_niva'], $allFT);

                        $allFT = str_replace('{var6}', $tmp_arr['5'], $allFT);
                        $allFT = str_replace('{var7}', $tmp_arr['6'], $allFT);
                        $allFT = str_replace('{var8}', $tmp_arr['7'], $allFT);
                        $allFT = str_replace('{R_var8_l9}', str_pad((ltrim(rtrim($tmp_arr['8']))), 9, ' ', STR_PAD_RIGHT), $allFT);
...
//$allFT = str_replace('{var10_niva}', $var10_niva, $allFT);
                        ...
                        //  $allFT = str_replace('{F1}', $ini_array['percorsi']['F1'], $allFT);
                        $allFT = str_replace('{F2}', $ini_array['percorsi']['F2'], $allFT);
                        $allFT = str_replace('{F1}',
                            //$ini_array['percorsi']['F3']
                            '230303'
                        ...
                        $allFT = '';
                        $allFT = str_replace('{var1}', $tmp_arr['0'], $ini_array['percorsi']['str_ft_2_niva']);
                        $allFT = str_replace('{var2}', $tmp_arr['1'], $allFT);
                        $allFT = str_replace('{var3}', $tmp_arr['2'], $allFT);
                        $allFT = str_replace('{var4}', $tmp_arr['3'], $allFT);
                        $allFT = str_replace('{var5}', $tmp_arr['4'], $allFT);
...
//$allFT = str_replace('{var10_niva}', $var10_niva, $allFT);
                        ...
                        $allFT = '';
                        $allFT = str_replace('{var1}', $tmp_arr['0'], $ini_array['percorsi']['str_ft_3_niva']);
                        $allFT = str_replace('{var2}', $tmp_arr['1'], $allFT);
                        $allFT = str_replace('{var3}', $tmp_arr['2'], $allFT);
                        $allFT = str_replace('{var4}', $tmp_arr['3'], $allFT);
                        $allFT = str_replace('{var5}', $tmp_arr['4'], $allFT);
...
//$allFT = str_replace('{var10_niva}', $var10_niva, $allFT);
                        ...
                        $allFT = '';
                        $allFT = str_replace('{var1}', $tmp_arr['0'], $ini_array['percorsi']['str_ft_4_niva']);
                        $allFT = str_replace('{var2}', $tmp_arr['1'], $allFT);
                        $allFT = str_replace('{var3}', $tmp_arr['2'], $allFT);
                        $allFT = str_replace('{var4}', $tmp_arr['3'], $allFT);
                        $allFT = str_replace('{var5}', $tmp_arr['4'], $allFT);
...
$s1 =
    ...
    $fatture . $corrispettivi);
            ...
            $s1 =
                str_replace('230301', '110301',
                $s1);
            $s1 =
                str_replace('230303', '110303',
                $s1);
            $s1 =
                str_replace('700121', '470103',
                $s1);
            $s1 =
                str_replace('310303', '190303',
                $s1);
...
//print_R($gen);
        $myfile = fopen("ft_conta.txt", "r+") or die("Unable to open file!");
        if (fwrite($myfile, $ndoc) === false) {
            echo "Cannot write to file (ft_conta)";
            exit;
